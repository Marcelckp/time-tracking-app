...
import './LittleHead.css';

class LittleHead extends Component {
    render() {

        let val;

        if (this.props.timeFrame === 'daily') {
            val = this.props.data.timeframes.daily;
        } else if ( this.props.timeFrame === 'weekly') {
            val = this.props.data.timeframes.weekly;
        } else if (this.props.timeFrame === 'monthly') {
            val = this.props.data.timeframes.monthly;
        }
                ...
                <div className="bottomer">
                    <div className="contentLittle">
                        ...
                        <div className="column2">
                            <h1 className="hrs">{val.current} hrs</h1>
                            <h1 className="last__Week">{saying} {val.previous} hrs</h1>
                        </div>
                    </div>
                </div>
            </div>
